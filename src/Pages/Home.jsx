  ...
  return (
    <div>
      ...
      <div className='lg:pt-12'>
        <h1 className='2xl:text-7xl xl:text-7xl 2xl:px-32 font-bold text-center lg:text-6xl md:text-3xl md:text-balance text-2xl w-[100%] px-10' >Call us now 123-456-7890 or send an email on info@Melvin.com</h1>
    ...
    <a className="text-center text-black font-semibold z-10 pointer-events-none uppercase 2xl:text-lg xl:text-xl lg:text-xl md:text-lg sm:text-2xl text-[90%]">Ask For Demostration</a>
  </div>
        </div>
      </div>
</div>
