    ...
    <div className="text-white ">
      <div className="relative h-full">
        ...
        <div className="absolute top-0 w-full h-auto 2xl:my-20 xl:my-34 lg:my-36 md:mt-16 mt-20 ">
          <div className="2xl:text-7xl xl:text-7xl text-center font-bold  md:text-6xl text-4xl px-4">
            Facts For Choosing Us
          </div>
          <p className="2xl:text-4xl text-center 2xl:mt-12 md:text-3xl text-xl px-12 mt-6 ">
            Lorem ipsum dolor sit consectetur adipiscing elit.
          </p>
          <p className="2xl:text-4xl text-center xl:mb-10 lg:mb-10 text-2xl px-12">
            Curabitur placerat tellus site.
          </p>

          <div className="flex 2xl:flex-nowrap xl:flex-row  lg:flex-row lg:flex-wrap lg:w-full   md:flex-col flex-col gap-10  2xl:my-16 2xl:mx-10  lg:mx-auto   relative xl:flex-wrap xl:justify-center md:px-28 md:mt-12 px-10 mt-10">
            <div className="2xl:h-80 h-auto 2xl:py-14 xl:py-0 lg:py-0 md:py-0 py-20 border-2 group relative  md:w-full 2xl:w-full xl:w-96 lg:w-80  lg:mx-auto w-auto md:h-56  rounded-lg  text-lg ">
              <div className="2xl:px-20 px-4 font-bold h-full md:py-10 md:text-center text-center">
                ...
                <h1 className="relative text-white group-hover:text-purple-500 2xl:text-7xl xl:text-7xl lg:text-7xl md:text-7xl text-5xl">
                  <ScrollTrigger onEnter={()=>setCounter(true)} onExit={()=>setCounter(false)}>
                  {counter ? <Countup start={0} end={52} duration={3} delay={0}/> : `52`}+
                  
                  </ScrollTrigger>
                </h1>
                <p className="relative text-white group-hover:text-purple-500 2xl:text-5xl xl:text-4xl lg:text-4xl  md:text-4xl text-2xl">
                  CLIENTS
                </p>
              </div>
            </div>
            <div className="2xl:h-80 h-auto 2xl:py-14 xl:py-0 lg:py-0 md:py-0 py-20 border-2 group relative lg:w-80 md:w-full 2xl:w-full xl:w-96 lg:mx-auto w-auto md:h-56  rounded-lg  text-lg ">
              <div className="2xl:px-20 px-4 font-bold h-full md:py-10 md:text-center text-center">
                ...
                <p className="relative text-white group-hover:text-purple-500 2xl:text-4xl xl:text-4xl lg:text-4xl  md:text-4xl text-2xl">
                  EXPERIENCE
                </p>
              </div>
            </div>
