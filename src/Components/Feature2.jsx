  ...
  return (
    <div className='2xl:py-40 xl:pb-36 xl:pt-2 xl:px-24 lg:px-24 lg:py-24 flex 2xl:flex-row gap-6 w-auto  2xl:px-56 xl:flex-row lg:flex-col lg:gap-16 md:flex-col md:py-24 md:gap-20 px-0 py-24 '>
      ...
      <div className='h-full  my-auto  lg:px-16 md:px-12 feature2'>
        <div>
            <h1 className='2xl:text-5xl xl:text-6xl font-bold lg:text-6xl md:text-6xl text-4xl 2xl:px-0 xl:px-0 lg:px-0 md:px-0 px-2 font-head'>With Care and Attention Over 15 Years</h1>
            <p className='2xl:text-2xl xl:text-2xl lg:text-2xl md:text-2xl 2xl:my-10 xl:my-8 md:my-8 lg:my-8 my-2 text-xl font-pragraph'>Lorem ipsum dolor sit amet, consectetur adipiscing elit Nulla accumsan, metus.</p>
        </div>
        <div className='flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col my-4 2xl:gap-6 xl:gap-6 md:gap-6 gap-2   2xl:px-0 xl:px-0 lg:px-0 md:px-0 px-4 pb-4 2xl:pt-0 xl:pt-0 lg:pt-0 md:pt-0 pt-8'>
            ...
            <div className='my-auto '>
                <h1 className='text-4xl font-bold my-2 font-head'>First Working Prosses</h1>
                <p className='2xl:text-2xl xl:text-2xl lg:text-2xl md:text-2xl text-xl font-pragraph'>Lorem ipsum dolor sit amet, consectetur adipiscing</p>
            </div>
        </div>
