  ...
  return (
    <div className=' 2xl:px-20 xl:mt-20 h-full ' >
      <div className='2xl:flex 2xl:flex-row 2xl:gap-16 xl:gap-16 lg:gap-16 md:gap-16 gap-12 justify-center py-20 md:flex-col lg:px-36 md:px-16 flex-col' data-aos="zoom-out" data-aos-offset="350">
        ...
        <h1 className='2xl:text-5xl xl:text-7xl lg:text-6xl md:text-5xl text-2xl font-bold mb-8'>About Our Company</h1>
        <p className='2xl:text-xl xl:text-3xl lg:text-xl md:text-xl text-lg mb-16'>Lorem ipsum dolor sit amet, consectetur adipiscing elit Nulla accumsan, metus.</p>
        <div className='flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col 2xl:gap-16 xl:gap-16 lg:gap-32 md:gap-40 '>
            <div className='2xl:w-[555px] 2xl:mb-0 xl:mb-0 lg:mb-0 md:mb-0 mb-16 2xl:pr-0 xl:pr-0 lg:pr-0 md:pr-0 pr-4'>
                ...
                <div>
                    <h1 className='2xl:text-3xl lg:text-3xl xl:text-5xl md:text-3xl text-xl  font-bold my-4'>Our Vision</h1>
                    <p className='2xl:text-xl xl:text-3xl lg:text-xl md:text-xl text-lg'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi, odit?</p>
                </div>
            </div>
            <div className='ww-80 2xl:mb-0 xl:mb-0 lg:mb-0 md:mb-0 mb-16 2xl:pr-0 xl:pr-0 lg:pr-0 md:pr-0 pr-4'>
                ...
                <div>
                    <h1 className='2xl:text-3xl lg:text-3xl xl:text-5xl md:text-3xl text-xl  font-bold my-4'>Our Mission</h1>
                    <p className='2xl:text-xl xl:text-3xl lg:text-xl md:text-xl text-lg'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi, odit?</p>
                </div>
            </div>
        </div>
